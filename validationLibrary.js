export default {
  ...
  validateFloatingPointNumber(input) {
  ...
  validateMinMaxLength(input, minLength, maxLength) {
  ...
  validateDateMonthDayYear(input) {
    const date =
  ...
  validateDateDayMonthYear(input) {
    const date =
